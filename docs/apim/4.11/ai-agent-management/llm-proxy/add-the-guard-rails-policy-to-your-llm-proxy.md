...
{% hint style="info" %}
You might receive an error when you use this policy using the Gravitee's docker image. This happens because the default images are based on Alpine Linux, which does not support the ONNX Runtime. To resolve this issue, you must use the Gravitee's docker image based on Debian. To download the correct image, use `graviteeio/apim-gateway:4.11.0-debian`.
{% endhint %}
...
1.  From the **Dashboard**, click **APIs**. <br>
    ...
    <figure><img src="../../.gitbook/assets/ai-mgmt-llm-proxy-add-the-guard-rai-97.png" alt=""><figcaption></figcaption></figure>
2.  In the **APIs** screen, click your LLM proxy. <br>

    <figure><img src="../../.gitbook/assets/ai-mgmt-llm-proxy-add-the-guard-rai-98.png" alt=""><figcaption></figcaption></figure>
